...
public class Board {
     ...
     * The board is used to keep track of the marks 'X' and 'O' placed by the
     * players,
     * with 0 representing an empty cell, 1 representing 'X', and 2 representing
     * 'O'.
     */
    public Board() {
        board = new int[3][3];
     ...
     *             Error messages are printed if the mark is not 'X' or 'O', or if
     *             the field is already marked and an overwrite is attempted.
